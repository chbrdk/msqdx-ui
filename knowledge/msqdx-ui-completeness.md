...
CHECKION score/issue gap (SeverityChip / ScoreStrip / IssueRow): `specs/domain/msqdx-ui-checkion-score-issue.md` — pilot via composition in checkion-v3 until implemented.  
...
## Done — Shell / overview Storybook (2026-08-03)

`AppFrame` · `NavRail` · `BrandCorner` · `TopStatus` · `KpiStrip` · `PipelinePanel` · `StatusMeterPanel` · `DivergingBar` · `WizardSteps` · `Icons` — CSF + MDX + catalog (`Templates` layer for AppFrame).  
Guard: `packages/ui/src/storybook/catalogCompleteness.test.ts` · audit `knowledge/storybook-coverage-audit-2026-08-03.md`.
