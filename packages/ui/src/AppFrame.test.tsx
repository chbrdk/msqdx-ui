...
describe('shared app shell primitives', () => {
  ...
  it('keeps top-right for brand plaque; shell cutouts cover the other three', () => {
    ...
    expect(TOP_LEFT_SHELL_CORNERS.topRight).toMatch(/^cutdown-/)
    expect(BOTTOM_LEFT_SHELL_CORNERS.topLeft).toMatch(/^cutdown-/)
    expect(BOTTOM_RIGHT_SHELL_CORNERS.topRight).toMatch(/^cutdown-/)
  })
})
