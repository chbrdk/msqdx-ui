...
export function MsqdxLogoMark({ size = 28, className, title = 'MSQ DX' }: MsqdxLogoMarkProps) {
  return (
    <svg
      className={className}
      width={size}
