...
| Slider | Atoms/Slider | packages/ui/src/components/Slider.stories.tsx | packages/ui/src/components/Slider.mdx |
...
| Meter | Molecules/Meter | packages/ui/src/components/Meter.stories.tsx | packages/ui/src/components/Meter.mdx |
| ScrollArea | Molecules/ScrollArea | packages/ui/src/components/ScrollArea.stories.tsx | packages/ui/src/components/ScrollArea.mdx |
| InspectDock | Molecules/InspectDock | packages/ui/src/components/InspectDock.stories.tsx | packages/ui/src/components/InspectDock.mdx |
| StepStrip | Molecules/StepStrip | packages/ui/src/components/StepStrip.stories.tsx | packages/ui/src/components/StepStrip.mdx |
| ChannelStack | Molecules/ChannelStack | packages/ui/src/components/ChannelStack.stories.tsx | packages/ui/src/components/ChannelStack.mdx |
| EventFooter | Molecules/EventFooter | packages/ui/src/components/EventFooter.stories.tsx | packages/ui/src/components/EventFooter.mdx |
