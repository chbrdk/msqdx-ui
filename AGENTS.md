...
7. Always-on Storybook staging: static image via root `Dockerfile` (port **6006**); operator notes in `knowledge/staging-coolify-storybook.md`; public URL placeholder `URL_MSQDX_UI_STORYBOOK` = `https://msqdx-ui.projects-a.plygrnd.tech`.
